...
const HeroSection = ({ onBuyNow }: HeroSectionProps) => {
  ...
  return (
    <section ref={sectionRef} onMouseMove={handleMouseMove} className="relative min-h-[75vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-hero pt-24 md:pt-20" style={{ perspective: '1200px', containIntrinsicSize: '0 90vh', contentVisibility: 'visible' }}>
