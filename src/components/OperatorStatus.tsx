...
const OperatorStatus = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-1 px-6 py-3 rounded-xl bg-primary/10 border border-primary/20 backdrop-blur-sm">
      ...
      <span className="text-sm font-medium text-primary">{bengaliDate}</span>
    </div>
  );
};
